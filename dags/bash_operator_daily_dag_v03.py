...
# Define the DAG with a cron schedule interval for every Tuesday at 07:30 AM
with DAG(
    dag_id='bash_operator_daily_dag_v03',
    start_date=datetime(2024, 9, 1),
    schedule_interval='30 7 * * 2',  # Cron expression: Every Tuesday at 07:30 AM
    catchup=True  # Catchup is True
) as dag:
