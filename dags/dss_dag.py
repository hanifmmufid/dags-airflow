...
def fetch_clean():
    ...
    database = '/home/hanifmmufid/airflow/dags/db/transactions.db'
    conn = sqlite3.connect(database)
    files = glob.glob("/home/hanifmmufid/airflow/dags/data_input_airflow/*.csv")
...
def report_generator(ti):
    ...
    for df in df_list:
        ...
        with pd.ExcelWriter(f'/home/hanifmmufid/airflow/dags/report/{periode}.xlsx') as writer:
